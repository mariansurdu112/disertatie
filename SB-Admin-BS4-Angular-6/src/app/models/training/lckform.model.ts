...
import {LineCheckDetails} from './formSections/lckDetails.model';

export class LineCheckForm {
    ID: number;
    FormType: string;
    Date: Date;
    Instructor: string;
    ...
    LineCheckDetails: LineCheckDetails;
    constructor(ID: number,
        ...
        ,
                ...
                LineCheckDetailsData: LineCheckDetails) {
        ...
        this.LineCheckDetails = LineCheckDetailsData
    }
}
