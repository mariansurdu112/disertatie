...
@Component({
  selector: 'app-crew-calendar',
  templateUrl: './crew-calendar.component.html',
  styleUrls: ['./crew-calendar.component.scss']
})
export class CrewCalendarComponent implements AfterViewInit {
