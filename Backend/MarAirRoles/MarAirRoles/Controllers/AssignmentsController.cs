...
namespace MarAirRoles.Controllers
{
    public class AssignmentsController : ApiController
    {
        ...
        //get assignments for crew
        [ResponseType(typeof(List<Assignments>))]
        public async Task<IHttpActionResult> GetAssignmentsForCrew(int id)
        {
            var assignments = await db.Assignments.Where(p=>p.CrewId==id).ToListAsync();
            return Ok(assignments);
        }
