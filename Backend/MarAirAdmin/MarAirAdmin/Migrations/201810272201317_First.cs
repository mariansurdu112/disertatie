    ...
    public partial class First : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .ForeignKey("dbo.ApplicationUsers", t => t.ModifiedBy, cascadeDelete: true)
                .Index(t => t.AsgType)
                .Index(t => t.FlightId)
                .Index(t => t.OtherId)
                .Index(t => t.LeaveId)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.CustomUserRoles", "ApplicationRole_Id", "dbo.ApplicationRoles");
            ...
            DropIndex("dbo.CustomUserRoles", new[] { "ApplicationRole_Id" });
